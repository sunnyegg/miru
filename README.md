...
- **Airing** — weekly AniList schedule with controls for adding titles to Watching, Planning, or Completed (temporarily disabled while AniList returns 403 for its API)
