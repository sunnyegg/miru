export namespace main {
	...
	export class EpisodeView {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.playbackPercent = source["playbackPercent"];
	    }
	}
	...
	export class RSSFeedItemsPageView {
	    items: RSSFeedItemView[];
	    total: number;
	
	    static createFrom(source: any = {}) {
	        return new RSSFeedItemsPageView(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.items = this.convertValues(source["items"], RSSFeedItemView);
